  ...
  return (
    <div className="content">
      <div className={checkActiveTab("react")}>
        <p>
          <b>React</b> makes it painless to create interactive UIs. Design
      ...
      <div className={checkActiveTab("vue")}>
        <p>
          <b>Vue</b> (pronounced /vjuː/, like view) is a JavaScript framework
      ...
      <div className={checkActiveTab("angular")}>
        <p>
          <b>Angular</b> is a development platform, built on TypeScrip With
          Angular, you're taking advantage of a platform that can scale from
          single-developer projects to enterprise-level applications. Angular is
          designed to make updating as straightforward as possible, so take
          advantage of the latest developments with a minimum of effort. Best of
          all, the Angular ecosystem consists of a diverse group of over 1.7
          million developers, library authors, and content creators
        </p>
      </div>
